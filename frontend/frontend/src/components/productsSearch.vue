<template>
  <div>
    <!-- <p>User Name: {{ userNameUpdate }}, Cookie role : {{}}</p> -->
...
export default {
  ...
  methods: {
    addToDB(itemID) {
      console.log(
        "Username from products_search component is \n username " +
          this.userNameUpdate +
          "\n ItemID " +
          itemID
      );
    ...
    printme(data) {
      console.log("User name from products search suer name := " + data);
    },
